"""
api/views.py ΓÇô Award & Scholarship Module
Thin views: handle Request/Response only.
All business logic ΓåÆ services.py | All DB queries ΓåÆ selectors.py
"""
...
class ScholarshipTypeListCreateView(APIView):
    """GET  /scholarships/api/types/  ΓÇô list all active types
       POST /scholarships/api/types/  ΓÇô create a new type"""
...
class ScholarshipTypeDetailView(APIView):
    """GET    /scholarships/api/types/<id>/  ΓÇô retrieve
       PATCH  /scholarships/api/types/<id>/  ΓÇô update
       DELETE /scholarships/api/types/<id>/  ΓÇô deactivate"""
...
class ScholarshipApplicationListCreateView(APIView):
    """GET  /scholarships/api/applications/  ΓÇô list all applications
       POST /scholarships/api/applications/  ΓÇô submit a new application"""
...
class ScholarshipApplicationDetailView(APIView):
    """GET    /scholarships/api/applications/<id>/  ΓÇô retrieve single application
       DELETE /scholarships/api/applications/<id>/  ΓÇô cancel a PENDING application"""
...
class ApplicationStatusUpdateView(APIView):
    """PATCH /scholarships/api/applications/<id>/update-status/  ΓÇô approve / reject / needs info"""
...
class ApplicationDisbursementView(APIView):
    """POST /scholarships/api/applications/<id>/disburse/  ΓÇô record disbursement"""
...
class EligibleStudentsView(APIView):
    """GET /scholarships/api/eligible-students/<scholarship_id>/  ΓÇô students eligible for a scholarship"""
